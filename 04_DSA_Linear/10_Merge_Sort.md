...
```
╔═══════════════════════════════════════════════════════════════╗
║       📦 MERGE SORT - DIVIDE, SORT, MERGE TOGETHER            ║
╠═══════════════════════════════════════════════════════════════╣
║                                                               ║
║  PHASE 1: TEILE (Divide)                                     ║
║  [38, 27, 43, 3, 9, 82, 10]                                  ║
║           ↓                                                  ║
║  [38, 27, 43, 3]  |  [9, 82, 10]                            ║
║          ↓              ↓                                    ║
...
║                                                               ║
║  💡 Teile in halbe, rekursiv sortieren                        ║
║  💡 Merge zwei sortierte Listen                              ║
║  💡 Garantiert O(n log n) - IMMER!                           ║
╚═══════════════════════════════════════════════════════════════╝
```
