...
```
╔═══════════════════════════════════════════════════════════════╗
║    🏗️ KLASSEN & OBJEKTE - BAUPLÄNE & REALE PRODUKTE           ║
╠═══════════════════════════════════════════════════════════════╣
║                                                               ║
║   KLASSE = BAUPLÄNE (Vorlage)                                 ║
║   ┌──────────────────────────────┐                            ║
║   │      class Dog:              │  ← BAUPLAN                 ║
║   │  • name                      │     (Was sind Hunde?)      ║
║   │  • age                       │                            ║
...
║   └──────────────────────────────┘                            ║
║                                                               ║
║   OBJEKTE = REALE PRODUKTE (Exemplare)                         ║
║   ┌──────────────┐    ┌──────────────┐    ┌──────────────┐   ║
║   │  dog1        │    │   dog2       │    │   dog3       │   ║
║   ├──────────────┤    ├──────────────┤    ├──────────────┤   ║
║   │name: "Rex"   │    │name: "Bella" │    │name: "Max"   │   ║
║   │age: 3        │    │age: 5        │    │age: 2        │   ║
║   │bark()        │    │bark()        │    │bark()        │   ║
║   └──────────────┘    └──────────────┘    └──────────────┘   ║
║                                                               ║
║   ↑ ALLE nutzen denselben BAUPLAN, aber unterschiedliche Daten ║
║                                                               ║
...
║   └────────────────────────────────────┘                      ║
║                                                               ║
║   __init__(self, name, age) = Konstruktor (Initialisierer)   ║
║   • Wird beim Erstellen aufgerufen                            ║
║   • Setzt die Anfangswerte                                    ║
║   • self = dieses Objekt                                      ║
║                                                               ║
║   💡 Klasse = WAS (Struktur)   Objekt = HOW MANY (Exemplare) ║
║   💡 Eine Klasse → Viele Objekte möglich                      ║
╚═══════════════════════════════════════════════════════════════╝
```
