...
```
╔═══════════════════════════════════════════════════════════════╗
║        🔭 LEGB RULE - WHERE PYTHON FINDS VARIABLES            ║
╠═══════════════════════════════════════════════════════════════╣
║                                                               ║
...
║   Python stops as soon as it finds the variable!             ║
║                                                               ║
║   💡 LEGB is searched from inside to outside                 ║
║   💡 First Local, then Enclosing, then Global, finally Built-in ║
╚═══════════════════════════════════════════════════════════════╝
```
