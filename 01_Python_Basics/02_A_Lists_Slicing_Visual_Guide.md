...
```
╔═══════════════════════════════════════════════════════════════╗
║          📋 LISTEN - GEORDNETE SAMMLUNG MIT INDIZES          ║
╠═══════════════════════════════════════════════════════════════╣
║                                                               ║
...
║   Negativ:  -4        -3         -2       -1                 ║
║                                                               ║
║   fruits[0] = "apple"         fruits[-1] = "date"            ║
║   fruits[1:3] = ["banana", "cherry"]  (Start inkl., Stop exkl.) ║
║   fruits[::2] = ["apple", "cherry"]  (jedes 2. Element)      ║
║   fruits[::-1] = ["date", "cherry", "banana", "apple"] (Umkehrung) ║
║                                                               ║
║   💡 Mutable, geordnet, erlaubt Duplikate                    ║
╚═══════════════════════════════════════════════════════════════╝
```
