...
╠═════════════════════════════════════════════════════════════════╣
║                                                                 ║
║   HASH TABLE (key-value):     HASH SET (values only):           ║
║   ┌──────────────────────┐    ┌──────────────────────┐         ║
║   │ "alice" → age: 25    │    │ "alice"              │         ║
║   │ "bob"   → age: 30    │    │ "bob"                │         ║
║   │ "carol" → age: 28    │    │ "carol"              │         ║
║   └──────────────────────┘    └──────────────────────┘         ║
║       (has values)                 (no values!)                 ║
║                                                                 ║
║   UNIQUENESS CHECK:                                            ║
║   Add element "alice" ──→ hash("alice") = 1                    ║
║   Add element "alice" ──→ hash("alice") = 1                    ║
║                           └──→ Already exists! SKIP            ║
║                                                                 ║
║   BUCKET ARRAY (no duplicates):                                ║
║   ┌───┬───┬─────┬───┬───┐                                      ║
║   │ 0 │ 1 │ 2   │ 3 │ 4 │                                      ║
║   │   │*1 │ *2  │*3 │ *5│  ← Only unique elements!            ║
║   └───┴───┴─────┴───┴───┘                                      ║
║         │   │    │    │                                        ║
║         Set: {1, 2, 3, 5}                                      ║
║                                                                 ║
║   💡 PERFECT FOR: Membership testing (O(1) average)            ║
║   💡 UNIQUE: Duplicates automatically rejected                 ║
║   💡 USE CASE: Remove duplicates, find unique items            ║
║                                                                 ║
╚═════════════════════════════════════════════════════════════════╝
```
